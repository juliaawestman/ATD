...
/*
    ...
    private JPanel buildMiddlePanel() {
        ...
        newGame = new JButton(new ImageIcon("src/main/resources/newGameButton.png"));
        newGame.addMouseListener(new NewGameListener(newGame));
        newGame.setBorderPainted(false);
        newGame.setContentAreaFilled(false);
        newGame.setFocusPainted(false);

        highScore = new JButton(new ImageIcon("src/main/resources/highScoreButton.png"));
    ...
    private JPanel buildLowerPanel() {
        ...
        sound = new JButton(new ImageIcon("src/main/resources/sound.png"));
